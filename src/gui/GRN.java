...
//  qty
    ...
    private void initComponents() {
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(jFormattedTextField2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Product ID", "Brand", "Name", "Stock ID", "Quantity ", "Buying Price", "Selling Price", "MFG", "EXP"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        supplierRegistration suplierRegistration = new supplierRegistration();
        suplierRegistration.setVisible(true);
        suplierRegistration.setGrn(this);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        grnItem.setQty(Double.parseDouble(jFormattedTextField2.getText()));
        ...
        if (grnItemMap.get(jTextField3.getText()) == null) {
            ...
            if (found.getExp().compareTo(exp) == 0
                ...
                JOptionPane.showMessageDialog(this, "GRN Item already exists with defferent date and prices", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
        loadGRNItems();
...
//                    new stock
                    ...
                    MySQL.execute("INSERT INTO `stock` (`product_id`,`price`,`qty`,`mfg`,`exp`) "
                            + "VALUES('" + grnItem.getProductId() + "','" + grnItem.getSellingPrice()+ "','" + grnItem.getQty()+ "',"
